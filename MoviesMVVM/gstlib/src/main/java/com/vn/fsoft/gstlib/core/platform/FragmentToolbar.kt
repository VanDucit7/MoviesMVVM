...
class FragmentToolbar(@IdRes val resId: Int,
    ...
    class Builder {
        ...
        private var isHideBackButton: Boolean = false

        fun isHideBackButton(isHideBackButton: Boolean) = apply { this.isHideBackButton = isHideBackButton }
