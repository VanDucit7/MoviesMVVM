...
import com.vn.fsoft.gstlib.BuildConfig

object Logger {

    private var mClassName: String = AppConstants.STRING_EMPTY
    private var mMethodName: String = AppConstants.STRING_EMPTY
